...
class TunerArguments:
    ...
    Args:
        ...
        freeze_router (bool): For MoE models only. If `True`, it freezes router/gate parameters during full
            fine-tuning and avoids attaching adapters to router modules. Defaults to `False`.
